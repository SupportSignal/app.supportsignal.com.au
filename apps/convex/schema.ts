...
export default defineSchema({
  ...
  // DEPRECATED TABLES REMOVED (Story 0.2 - Database Schema Audit)
  // - chat_sessions, chat_messages: POC chat system (August 2025) - Code removal tracked in Story 0.3
  // - source_documents, document_chunks: POC knowledge ingestion spike (Story 4.2) - Code removal tracked in Story 0.3
  // Backup: apps/convex/schema.ts.backup-YYYYMMDD-HHMMSS
  ...
  participants: defineTable({
    ...
    site_id: v.optional(v.id("sites")), // Which site the participant is associated with
    first_name: v.string(),
    last_name: v.string(),
  ...
  // Note: ai_prompt_templates and prompt_usage_logs tables removed - unused legacy system
  // The active system uses ai_prompts table instead
