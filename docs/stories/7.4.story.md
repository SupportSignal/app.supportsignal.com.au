...
- `docs/lessons-learned/company-creation-validation-bug.md` - Validation error clearing pattern for auto-populated fields
- `docs/patterns/convex-error-handling.md` - Error handling patterns with ConvexError

**Pattern Documentation:**
- Migration script pattern for adding required foreign keys to existing data
- Auto-selection with validation error cleanup pattern
- Site-based filtering and organization approach
