...
1. ✅ Enhanced schema.ts with 8 tables: companies, incidents, incidentNarratives, clarificationQuestions, clarificationAnswers, incidentAnalysis, incidentClassifications, aiPrompts
2. ✅ Updated existing users table with multi-tenant support (companyId, snake_case roles)
