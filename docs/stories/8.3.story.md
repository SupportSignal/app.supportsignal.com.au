...
- [ ] Task 1: Create production GitHub OAuth application (AC: 1)
  - [ ] Access GitHub Developer Settings
  - [ ] Create new OAuth App for production
  - [ ] Configure callback URLs: `https://app.supportsignal.com.au/auth/github/callback`
  - [ ] Configure homepage URL: `https://app.supportsignal.com.au`
  - [ ] Record client ID and client secret

- [ ] Task 2: Create production Google OAuth application (AC: 2)
  - [ ] Access Google Cloud Console
  - [ ] Create new OAuth 2.0 credentials for production
  - [ ] Configure authorized redirect URIs: `https://app.supportsignal.com.au/auth/google/callback`
  - [ ] Configure authorized origins: `https://app.supportsignal.com.au`
  - [ ] Record client ID and client secret

- [ ] Task 3: Update production environment variables (AC: 3)
  - [ ] Use environment management system to set production OAuth credentials
  - [ ] Update `GITHUB_CLIENT_ID` for production
  - [ ] Update `GITHUB_CLIENT_SECRET` for production
  - [ ] Update `GOOGLE_CLIENT_ID` for production
  - [ ] Update `GOOGLE_CLIENT_SECRET` for production
  - [ ] Deploy environment variables to production Convex deployment

- [ ] Task 4: Test authentication flows (AC: 4)
  - [ ] Test GitHub OAuth in development environment
  - [ ] Test Google OAuth in development environment
  - [ ] Test GitHub OAuth in production environment
  - [ ] Test Google OAuth in production environment
  - [ ] Verify callback URLs work correctly in both environments
  - [ ] Test complete authentication workflow end-to-end

- [ ] Task 5: Documentation and verification
  - [ ] Document OAuth application configurations
  - [ ] Verify no authentication disruption in production
