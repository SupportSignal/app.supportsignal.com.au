...
- [ ] **Task 3.3.1: AI Narrative Enhancement Backend** (AC: 1, 7)
  - [ ] Subtask 3.3.1.1: Implement AI service for narrative enhancement with basic grammar fixes and Q&A integration
  - [ ] Subtask 3.3.1.2: Create enhanced narrative storage with original/enhanced/qa_content separation and version history
...
- [ ] **Task 3.3.2: Enhanced Review Interface (Step 7)** (AC: 2, 3, 4, 5)
  - [ ] Subtask 3.3.2.1: Create EnhancedReviewStep component for Step 7 with collapsible original content
  - [ ] Subtask 3.3.2.2: Implement OriginalContentCollapse component with default collapsed state
  - [ ] Subtask 3.3.2.3: Create QADisplayCollapse component showing only answered questions
  - [ ] Subtask 3.3.2.4: Add enhanced narrative edit capabilities with visual change tracking
  - [ ] Subtask 3.3.2.5: Implement clear visual separation between original and enhanced content

- [ ] **Task 3.3.3: Consolidated Report Preview (Step 8)** (AC: 6, 8, 9)
  - [ ] Subtask 3.3.3.1: Create ConsolidatedReportStep component for Step 8 comprehensive overview
  - [ ] Subtask 3.3.3.2: Implement IncidentSummaryDisplay with complete incident information
  - [ ] Subtask 3.3.3.3: Add workflow completion checklist with validation summary
  - [ ] Subtask 3.3.3.4: Create export preview functionality showing final incident report format

- [ ] **Task 3.3.4: Workflow Integration and Testing** (AC: 1-9)
  - [ ] Subtask 3.3.4.1: Extend IncidentCaptureWorkflow to support Steps 7-8
  - [ ] Subtask 3.3.4.2: Add comprehensive unit tests for enhancement, collapsible UI, and consolidated report
  - [ ] Subtask 3.3.4.3: Implement integration tests for complete Steps 1-8 workflow
  - [ ] Subtask 3.3.4.4: Add end-to-end testing including two-step review process and export preview
